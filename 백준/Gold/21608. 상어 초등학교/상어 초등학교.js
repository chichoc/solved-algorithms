...
console.log(answer);
// 오래 걸린 이유
// 1) filter가 sort처럼 원본 배열을 변경하는 걸로 착각함
// 2) 순회하면서 규칙1과 규칙2를 한 번에 해결하려다가 꼬임
// - 좋아하는 학생이 가장 많이 인접한 칸 중에서 비어있는 칸이 가장 많은 칸을 구해야하는데,
// - 비어있는 칸이 가장 많이 인접한 칸을 따로 구해서 안 겹치는 경우 발생
